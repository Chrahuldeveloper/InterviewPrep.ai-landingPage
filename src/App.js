    ...
    <div className="bg-[#fcfdff] min-h-screen">
      <div className="flex items-center justify-between w-full px-6 py-4 bg-white border-b border-gray-200 md:px-20">
        <div className="flex items-center space-x-2 text-xl font-semibold">
          <div className="px-2 py-1 text-white bg-black rounded">IQ</div>
      ...
      <div className="flex flex-col items-center px-6 py-12 justify-evenly md:px-28 md:flex-row">
        <div className="max-w-xl space-y-6 text-center md:text-left">
          ...
          <p className="text-lg text-gray-600">
            Every time you apply for a job, our extension has you covered. Get
          ...
          {[
            {
              ...
              initials: "SC",
              review:
                "Helped me prep faster before interviews! I got relevant questions for every job I applied to.",
            },
            {
              name: "Raj Patel",
